namespace _99_Legacy
{
     ...
     * 
     * SkinShop, CharCuz og ChoosePlayer GO skal alle v�re aktive n�r start spillet ellers virker det ikke
     * De bliver set.Active(true) i NewGame som er p� GameManger.
     ...
     * 
     * Inde i PlayerWorldMovement under FindNPC metoden mangler vi at g�re s� man ikke skal �bne Wardrope f�r man kan �bne shoppen
     * 
