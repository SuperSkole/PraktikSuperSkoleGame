...
namespace Scenes.Minigames.MonsterTower
{
    ...
    /// </summary>
    /// 
    public class FileDataHandler1
    {
        private string dataDirPath = "";

        private string dataFileName = "";

        public FileDataHandler1(string dataDirPath, string dataFileName)
        {
        ...
        public GameData1 Load()
        {
            string fullPath = Path.Combine(dataDirPath, dataFileName);

            GameData1 loadedData = null;
            ...
            if (File.Exists(fullPath))
            {
                try
                {
                    ...
                    loadedData = JsonUtility.FromJson<GameData1>(dataToLoad);
        ...
        public void Save(GameData1 data)
        {
