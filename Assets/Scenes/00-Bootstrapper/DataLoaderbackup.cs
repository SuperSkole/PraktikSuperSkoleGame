...
namespace Scenes._00_Bootstrapper
{
    ...
    /// </summary>
    public class DataLoaderbackup : MonoBehaviour
    {
        ...
        private IEnumerator LoadAllletterSounds()
        {
            ...
            string[] fileEntries = Directory.GetFiles(directoryPath, "*.mp3");
            foreach (string filePath in fileEntries)
            {
        ...
        private IEnumerator LoadAllCongratsSounds()
        {
            ...
            string[] fileEntries2 = Directory.GetFiles(directoryPath, "*.mp3");
