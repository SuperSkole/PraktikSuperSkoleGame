...
namespace UI.Scripts
{
    public class ClothingManager : MonoBehaviour
    {
        ...
        private void InitializeClothes()
        {
            ...
            AvailableClothesList.Add(new ClothInfo { ID = 5, image = halstorklade, Price = 100, Name = "Halst�rkl�de", SpineName = "Monster MID Halst�rkl�de" });
            AvailableClothesList.Add(new ClothInfo { ID = 6, image = ballerinaskort, Price = 200, Name = "Ballerinask�rt", SpineName = "Monster MID Ballerinask�rt" });

            AvailableClothesList.Add(new ClothInfo { ID = 7, image = rod, Price = 20, Name = "R�d", SpineName = "red" });
            AvailableClothesList.Add(new ClothInfo { ID = 8, image = gron, Price = 20, Name = "Gr�n", SpineName = "green" });
            AvailableClothesList.Add(new ClothInfo { ID = 9, image = bla, Price = 20, Name = "Bl�", SpineName = "blue" });
