...
namespace UI.Scripts
{
    public class ClothingManager : PersistentSingleton<ClothingManager>
    {
        ...
        {
            // SHOPITEMS
            AvailableClothesList.Add(new ClothInfo { ID = 1, image = briller, Price = 2, Name = "Briller", SpineName = "Monster HEAD Briller" });
            AvailableClothesList.Add(new ClothInfo { ID = 2, image = tryllehat, Price = 5, Name = "Tryllehat", SpineName = "Monster HEAD Tryllehat" });
            AvailableClothesList.Add(new ClothInfo { ID = 3, image = tophat, Price = 8, Name = "Tophat", SpineName = "Monster HEAD Tophat" });

            AvailableClothesList.Add(new ClothInfo { ID = 4, image = slips, Price = 5, Name = "Slips", SpineName = "Monster MID Slips" });
            AvailableClothesList.Add(new ClothInfo { ID = 5, image = halstorklade, Price = 5, Name = "Halst\u00f8rkl\u00e6de", SpineName = "Monster MID Halst\u00f8rkl\u00e6de" });
            AvailableClothesList.Add(new ClothInfo { ID = 6, image = ballerinaskort, Price = 10, Name = "Ballerinask\u00f8rt", SpineName = "Monster MID Ballerinask\u00f8rt" });

            AvailableClothesList.Add(new ClothInfo { ID = 7, image = rod, Price = 5, Name = "R\u00f8d", SpineName = "red" });
            AvailableClothesList.Add(new ClothInfo { ID = 8, image = gron, Price = 5, Name = "Gr\u00f8n", SpineName = "green" });
            AvailableClothesList.Add(new ClothInfo { ID = 9, image = bla, Price = 5, Name = "Bl\u00e5", SpineName = "blue" });
            AvailableClothesList.Add(new ClothInfo { ID = 10, image = gul, Price = 5, Name = "Gul", SpineName = "orange" });
            AvailableClothesList.Add(new ClothInfo { ID = 11, image = hvid, Price = 5, Name = "Hvid", SpineName = "white" });
            AvailableClothesList.Add(new ClothInfo { ID = 12, image = pink, Price = 5, Name = "Pink", SpineName = "pink" });
